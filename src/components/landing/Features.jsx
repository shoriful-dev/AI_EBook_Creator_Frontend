      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-gray-900 tracking-tight">
            ...
            <span className='block mt-2 bg-linear-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent'>Create Your Book</span>
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className='relative space-y-4'>
                  ...
                  <div>
                    <h3 className='text-3xl font-bold text-gray-900 mb-3 group-hover:text-violet-900 transition-colors'>{feature.title}</h3>
