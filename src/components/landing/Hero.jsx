      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/50 backdrop:blur-sm px-4 py-2 rounded-full border border-violet-100 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link
                ...
                className="group inline-flex items-center space-x-2 bg-linear-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200 font-semibold"
              >
