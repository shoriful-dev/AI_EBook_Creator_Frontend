    ...
    <div id='testimonials' className='relative py-24 lg:py-32 bg-linear-to-br from-violet-50 via-purple-50 to-white overflow-hidden'>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 className='text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight'>Loved by Creators <span className='block mt-2 bg-linear-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent'>Everywhere</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className="group relative bg-white/80 backdrop:blur-sm rounded-3xl p-8 border border-gray-100 hover:border-violet-200 transition-all duration-300 hover:shadow-2xl hover:shadow-violet-500/10 hover:-translate-y-2">
              {/* Quote Icon */}
              ...
              <div className="flex items-center space-x-1 mb-6">
                {[...Array(testimonial.rating)].map((_, starIndex) => (
                  <Star key={starIndex} className='w-5 h-5 text-violet-500 fill-violet-500'/>
                ))}
              </div>
              {/* Quote */}
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  ...
                  <img src={testimonial.avatar} alt="testimonial avatar" className='relative w-14 h-14 rounded-full object-cover ring-2 ring-white shadow-lg'/>
                </div>
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">Avarage Rating</div>
          </div>
          <div className="text-center">
