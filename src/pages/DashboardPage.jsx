...
const BookCardSkeleton = () => {
  return (
    <div className="animate-pulse bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
...
const DashboardPage = () => {
  ...
  const handleDeleteBook = async () => {
    ...
    try {
      ...
      toast.error(
        error.response?.data?.message ||
          'Failed to delete eBook. Please try again.',
      );
    } finally {
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed border-slate-200 rounded-xl mt-8">
            ...
            <p className="text-slate-500 mb-6 max-w-md">
              You have't created any eBooks yet. Get started by creating your
              first one.
            </p>
